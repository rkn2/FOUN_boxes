...
\begin{abstract}
This study presents a data-driven approach to assess structural vulnerability and develop intervention strategies for adobe structures, using Fort Union National Monument (FOUN) as a case study. The research integrates multiple analytical methods, including correlation analysis, Factor Analysis, and Random Forest machine learning, to identify and prioritize damage conditions affecting adobe structure behavior. The study analyzed various degradation mechanisms, including adobe wall deterioration, foundation issues, and shelter coat damage. 
Data collection involved on-site surveys, archival research, and LiDAR scanning. The analysis revealed key latent factors associated with degradation, specifically identifying distinct clusters of damage related to sill deterioration, surface/lintel issues, and structural instability. Random Forest analysis indicated that geometric properties, specifically foundation height and wall height, are the most significant predictors of overall degradation scores in this dataset, outweighing the importance of specific past treatments. Based on these findings, intervention matrices were developed, incorporating preservation standards. 
The results illustrate the potential of this data-driven methodology for identifying vulnerabilities and informing preservation strategies. The study provides a structured approach to prioritizing interventions, balancing historical preservation requirements with structural integrity concerns. This methodology offers a replicable framework for the assessment of adobe structures, though validation at additional sites and longitudinal monitoring are needed to confirm intervention effectiveness.
...
The Kaiser-Meyer-Olkin (KMOAd) measure of sampling adequacy was 0.558, falling slightly below the conventional 0.6 threshold (Kaiser's "mediocre" classification).
We proceeded with Factor Analysis for several reasons: (1) Bartlett's test strongly rejects variable independence (χ² = 376.04, df = 28, p < 0.001), (2) individual variable KMO values for key damage indicators exceed 0.6 (Lintel Deterioration: 0.66, Coat 2 Cracking: 0.76), (3) the extracted factors align with theoretically meaningful damage mechanisms, and (4) the small sample size (n=67) may artificially depress KMO values in exploratory analyses.
...
Random Forest analysis produced initially counterintuitive results: visible damage indicators (Coat 2 Cracking, Structural Cracking, Out of Plane) dominated feature importance (0.21, 0.18, 0.11), while geometric properties (Height, Foundation Height) ranked lower (0.055, 0.024). This reflects analytical circularity—Total Score aggregates damage types, so existing damage naturally predicts that aggregate. The supplemental analysis excluding damage indicators clarified geometric factor influence: using only nine geometric/contextual variables, the model achieved CV R² = 0.29, approximately 56\% of full-model performance. Point Cloud Mean (surface irregularity from LiDAR), Height, and Foundation Height emerged as the top three predictors, confirming their value for preventive risk stratification when detailed damage surveys are unavailable.
